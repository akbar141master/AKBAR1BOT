...
//
const BotName = ' 🐼ᗩKᗷᗩᖇ ᗷOT 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/akbar__ofc'; // Nama Instagramlu cok
const whatsapplu = '+5511997843379'; // Nomor whatsapplu cok
...
conn.sendMessage(id, 'waalaikumsalam, how can I help you? if confused type #help ya say..' ,MessageType.text);
}
else if (text == 'salam'){
...
conn.sendMessage(id, 'Yes can I help you? if confused type #help ya say..' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Yes can I help you? if confused type #help ya say..' ,MessageType.text);
}
